...
const CardNav: React.FC<CardNavProps> = ({
  ...
  const themeColors = {
    light: {
      ...
      primary: '#059669',    // Dark green primary
      secondary: '#6cb654',  // Light green secondary
      accent: '#059669'      // Dark green accent
    },
    dark: {
      background: '#2d2d2d', // Dark grey background
      primary: '#6cb654',    // Light green primary
      secondary: '#059669',  // Dark green secondary
      accent: '#6cb654'      // Light green accent
    }
  };
      ...
      >
        <div className="card-nav-top absolute inset-x-0 top-0 h-[60px] flex items-center justify-between p-2 pl-[1.1rem] z-[2]">
          ...
          <button
            ...
            className="hidden md:flex items-center justify-center p-2 rounded-lg transition-colors duration-300 hover:bg-opacity-80"
            style={{
